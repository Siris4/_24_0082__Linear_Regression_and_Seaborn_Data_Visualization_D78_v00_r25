...
# Apply Seaborn styling and create the bubble plot
with sns.axes_style('darkgrid'):  #can also use: 'whitegrid', 'dark', or 'ticks'
...
plt.savefig('bubble_plot_with_styling.png')
